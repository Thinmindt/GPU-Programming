...
int main(int argc, char* argv[])
{
    ...
    dim3 dim_grid(ceil((float)imageWidth/FILTER_SIZE),ceil((float)imageHeight/FILTER_SIZE));
    // dim3 dim_grid((imageWidth + BLOCK_SIZE - 1) / BLOCK_SIZE, (imageHeight + BLOCK_SIZE - 1) / BLOCK_SIZE); 
    // dim3 dim_grid((imageWidth - 1) / BLOCK_SIZE + 1, (imageHeight - 1) / BLOCK_SIZE + 1);
