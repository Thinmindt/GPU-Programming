...
void cudaCheck(cudaError_t cuda_ret) {
...
int main (int argc, char *argv[])
{
    ...
    cuda_ret = cudaMalloc(&A_d, A_sz * sizeof(float));
    cudaCheck(cuda_ret);
    cuda_ret = cudaMalloc(&B_d, B_sz * sizeof(float));
    cudaCheck(cuda_ret);
    cuda_ret = cudaMalloc(&C_d, C_sz * sizeof(float));
    cudaCheck(cuda_ret);
